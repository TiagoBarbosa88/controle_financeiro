...
@Component({
  selector: 'app-transaction-input2',
  templateUrl: './transaction-input2.component.html',
  styleUrls: ['./transaction-input2.component.css']
})
export class TransactionInput2Component implements OnInit{
